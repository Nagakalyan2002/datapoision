...
main = tkinter.Tk()
main.title("SCHEMES TO DETECT DATA POISON UNDER DISTRIBUTED ENVIRONMENT")
...
font = ('times', 14, 'bold')
title = Label(main, text='SCHEMES TO DETECT DATA POISON UNDER DISTRIBUTED ENVIRONMENT')
